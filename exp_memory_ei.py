...
PAUSE = 150 * ms
K = 5
# (w_scale in nA-relative pamp, inh_scale, tau_m, tau_syn)
COMBOS = [
    {"w_scale": 0.001 * nA, "inh_scale": 1.0},
    {"w_scale": 0.001 * nA, "inh_scale": 0.5},
    {"w_scale": 0.001 * nA, "inh_scale": 2.0},
    {"w_scale": 0.002 * nA, "inh_scale": 1.0},
    {"w_scale": 0.002 * nA, "inh_scale": 2.0},
    {"w_scale": 0.003 * nA, "inh_scale": 1.0},
    {"w_scale": 0.003 * nA, "inh_scale": 2.0},
    {"w_scale": 0.001 * nA, "inh_scale": 2.0, "tau_m": 20 * ms, "tau_syn": 5 * ms},
    {"w_scale": 0.002 * nA, "inh_scale": 2.0, "tau_m": 20 * ms, "tau_syn": 5 * ms},
    {"w_scale": 0.001 * nA, "inh_scale": 2.0, "tau_m": 30 * ms, "tau_syn": 5 * ms},
    {"w_scale": 0.002 * nA, "inh_scale": 3.0, "tau_m": 20 * ms, "tau_syn": 5 * ms},
]
...
def main():
    ...
    print(f"{'config':26s} {'word':6s} {'tot':>7s} | "
    ...
    for c in COMBOS:
        ...
        for w in WORDS:
            ...
            print(f"{label:26s} {w:6s} {np.mean(tots[w]):7.1f} | {intra:8.1f} "
