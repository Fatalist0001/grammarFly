...
K = 5
COMBOS = [
    {"w_scale": 2 * nA * 0.001, "inh_scale": 3.0, "tau_m": 20 * ms, "tau_syn": 5 * ms},
    {"w_scale": 2 * nA * 0.001, "inh_scale": 5.0, "tau_m": 20 * ms, "tau_syn": 5 * ms},
    {"w_scale": 3 * nA * 0.001, "inh_scale": 4.0, "tau_m": 20 * ms, "tau_syn": 5 * ms},
    {"w_scale": 3 * nA * 0.001, "inh_scale": 8.0, "tau_m": 20 * ms, "tau_syn": 8 * ms},
    {"w_scale": 4 * nA * 0.001, "inh_scale": 8.0, "tau_m": 30 * ms, "tau_syn": 8 * ms},
    {"w_scale": 1 * nA * 0.001, "inh_scale": 2.0, "tau_m": 20 * ms, "tau_syn": 5 * ms},
]
...
def main():
    ...
    print(f"{'config':28s} {'word':6s} {'tot':>7s} {'pos%':>5s} | "
    ...
    for c in COMBOS:
        ...
        for w in WORDS:
            ...
            print(f"{label:28s} {w:6s} {np.mean(tots[w]):7.1f} {pos:5.0f} | {intra:8.1f} "
